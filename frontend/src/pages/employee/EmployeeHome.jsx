...
export default function EmployeeHome() {
  ...
  const quickActions = [
    { label: 'Explore CSR', href: '/app/social', description: 'Find activities to support', icon: HandHeart, tone: 'bg-blue-50 text-blue-700' },
    { label: 'View policies', href: '/app/governance', description: 'Read assigned policies', icon: ScrollText, tone: 'bg-violet-50 text-violet-700' },
    { label: 'Find challenges', href: '/app/challenges', description: 'Take meaningful action', icon: Target, tone: 'bg-amber-50 text-amber-700' },
  ]

  return (
    <AppShell navItems={employeeNav} experience="Employee portal">
